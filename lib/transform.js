...
exports.transform = function (rules, object, preserve_original) {
	if (typeof preserve_original === 'undefined') {
		preserve_original = false
	}

	var new_object = _.clone(object)
	return _.extend(transform_sub(rules, new_object, object), preserve_original ? new_object : {})
}